...
public class oQ {
   ...
   public String dN() {
      try {
         ...
         var2.dN();
         byte[] var3 = PX.dN((byte[])var1.toByteArray(), (int[])null);
         return PX.dN(var3);
   ...
   public boolean dN(String var1, int[] var2) {
      return true;
   }

   private int dN(int var1) {
      int var2;
      for(var2 = 0; var1 > 0; var1 >>= 4) {
         var2 += var1 & 15;
      }
