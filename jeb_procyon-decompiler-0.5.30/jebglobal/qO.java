...
public final class qO extends as
{
    private Os KK;
    
    public qO(final Os kk) {
        super(kk, "Comment");
        this.KK = kk;
        this.ld = 99;
        this.wU = 47;
    ...
    private boolean dN(final boolean b) {
        ...
        if (vd != null) {
            ...
            if (dn2 != null) {
                ...
                if (s == null) {
                    final int lastIndex = ms.lastIndexOf("  //");
                    if (lastIndex >= 0) {
                    ...
                    final int n3 = ms.length() - ms.lastIndexOf("//", ms.length() - s.length()) + 2;
